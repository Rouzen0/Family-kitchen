...
public class ChatAdapterDelivery extends RecyclerView.Adapter<ChatAdapterDelivery.ViewHolder> {

    ArrayList<ChatDelivery> list;
    ...
    public ChatAdapterDelivery(Context ctx, ArrayList <ChatDelivery> list) {
        this.list = list;
        context=ctx;
    }
