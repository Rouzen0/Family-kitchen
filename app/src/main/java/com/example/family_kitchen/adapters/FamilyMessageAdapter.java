...
import com.example.family_kitchen.ui.family.activities.FamilyChatActivity;
...
public class FamilyMessageAdapter extends RecyclerView.Adapter<FamilyMessageAdapter.ViewHolder> {
    ...
    public FamilyMessageAdapter(Context ctx, ArrayList <Cart> list) {
        this.list = list;
        context=ctx;
    }
