...
import com.example.family_kitchen.databinding.ActivityCustomerChatBinding;
    ...
    private void fetchItemsData() {
        ...
        db_chat.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                chatAdapter = new ChatAdapter(CustomerChatActivity.this, itemArrayCartList);
                binding.rvItems.setLayoutManager(new GridLayoutManager(CustomerChatActivity.this, 1));
